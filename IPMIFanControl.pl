...
#pulled from https://jp-powers.com/wp-content/uploads/2017/07/IPMIFanControl.pl_.txt
...
## LOG
$log = 'IPMIFanControl.log'; #Ubuntu mod - I personally added my home directory to make it easy to spot check temps, so /home/<username>/IPMIFanControl.log instead
...
$cpu_max_fan_speed    = 13000;
$hd_max_fan_speed     = 3500;
...
sub print_log_header
{
    ...
    print LOG "  Max   Ave  Temp   Fan   Fan  Fan %   CPU    P      I      D    HDFan   CPUFan\n$datestring";
    ...
    print LOG "Temp  Temp   Err  Mode   RPM Old/New Temp  Corr   Corr   Corr    Duty    Level\n";
...
sub get_fan_speed
{
    ...
    elsif( $fan_speed > 20000 || $fan_speed < 0 )
    {
